package com.java.sjq.messagequeue.kafaka.multiConsumerGroup.demo;
...
public class ProducerFastStart {
    ...
    public static final String TOPIC1 = "itcast-heima";
    public static final String TOPIC2 = "itcast-baima";
